...
2. Add the definition to your proxy "tsdproxy.dash.icon" in [docker provider]({{< ref "/docs/docker.md" >}}#tsdproxydashicon)
or "icon" in dashboard section for [Proxy List]({{< ref "/docs/list.md" >}}#proxy-list-file-options)
