...
title: Nextcloud
weight: 3
prev: /docs/v2/examples/home-assistant
next: /docs/v2/examples/grafana-stack
---
...
| `tsdproxy.dash.icon` | `"si/nextcloud"` | Dashboard icon (from Simple Icons). See [icons]({{< ref "/docs/v2/advanced/icons" >}}) for available options |
