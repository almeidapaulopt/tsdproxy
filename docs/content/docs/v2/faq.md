...
See the [introduction]({{< ref "/docs/v2/_index" >}}) for a full overview.
...
[upgrading guide]({{< ref "/docs/v2/upgrading/from-v1" >}}) for migration details.

## Can I use TSDProxy without Docker?

Yes. You can run TSDProxy as a standalone binary and use the
[Lists provider]({{< ref "/docs/v2/providers/lists" >}}) to define proxies by
IP address or hostname. See the
[standalone deployment]({{< ref "/docs/v2/deployment/standalone" >}}) page for
instructions.
...
[Authentication Methods]({{< ref "/docs/v2/security/auth-methods" >}}) for a
comparison.
...
proxy in the [dashboard]({{< ref "/docs/v2/advanced/dashboard" >}}) to
...
[Docker provider]({{< ref "/docs/v2/providers/docker" >}}) docs for details.
...
[host network mode]({{< ref "/docs/v2/advanced/host-mode" >}}) for examples.

## Can I proxy services not running in Docker?

Yes. The [Lists provider]({{< ref "/docs/v2/providers/lists" >}}) lets you
...
Yes, using [Tailscale Funnel]({{< ref "/docs/v2/security/funnel" >}}). Add the
...
[TCP Proxy & SSH]({{< ref "/docs/v2/advanced/tcp-proxy" >}}) for configuration
examples.
...
`http://127.0.0.1:8080`). The [dashboard]({{< ref "/docs/v2/advanced/dashboard" >}})
page has step-by-step instructions for both methods.

## Can I run multiple TSDProxy instances?

Yes. Check the [scenarios]({{< ref "/docs/v2/scenarios" >}}) section for common
...
See the [tags section]({{< ref "/docs/v2/advanced/tailscale#tags" >}}) for
details.
...
[roadmap]({{< ref "/docs/v2/advanced/roadmap#multi-target-load-balancing" >}}).
...
> [prevent duplicates section]({{< ref "/docs/v2/advanced/tailscale#prevent-duplicate-machines" >}})
> before enabling it.
