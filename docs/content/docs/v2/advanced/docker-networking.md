...
prev: /docs/v2/advanced/environment-variables
next: /docs/v2/advanced/headscale
---
...
> were tried and why they failed. See [Enabling debug logging]({{< ref "/docs/v2/troubleshooting#enabling-debug-logging" >}}).
...
Both approaches are described in the [Docker labels]({{< ref "/docs/v2/providers/docker#port-options" >}})
documentation.
...
[Service with host network_mode]({{< ref "/docs/v2/advanced/host-mode" >}}).
...
[Troubleshooting]({{< ref "/docs/v2/troubleshooting" >}}).
