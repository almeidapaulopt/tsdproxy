...
2. Add the definition to your proxy "tsdproxy.dash.icon" in [docker provider]({{< ref "/docs/v1/docker.md" >}}#tsdproxydashicon)
or "icon" in dashboard section for [Proxy List]({{< ref "/docs/v1/list.md" >}}#proxy-list-file-options)
