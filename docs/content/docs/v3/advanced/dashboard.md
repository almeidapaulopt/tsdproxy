...
> [Server Configuration]({{< ref "/docs/v3/serverconfig#hostname" >}}) for details.
...
> [Admin Allowlist]({{< ref "/docs/v3/security/admin-allowlist" >}}) and
> [Troubleshooting]({{< ref "/docs/v3/troubleshooting#access-requires-a-tailscale-connection-on-dashboard" >}})
> for details.
...
| `tsdproxy.dash.icon` | auto-detected | Icon for the proxy card (see [icons]({{< ref "/docs/v3/advanced/icons" >}})) |
...
> [Dashboard icons]({{< ref "/docs/v3/advanced/icons" >}}) for the full list of
...
See [Admin Allowlist]({{< ref "/docs/v3/security/admin-allowlist#viewer-role" >}}) for
