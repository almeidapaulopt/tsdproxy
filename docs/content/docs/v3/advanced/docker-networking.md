...
> were tried and why they failed. See [Enabling debug logging]({{< ref "/docs/v3/troubleshooting#enabling-debug-logging" >}}).
...
Both approaches are described in the [Docker labels]({{< ref "/docs/v3/providers/docker#port-options" >}})
documentation.
...
[Service with host network_mode]({{< ref "/docs/v3/advanced/host-mode" >}}).
...
[Troubleshooting]({{< ref "/docs/v3/troubleshooting" >}}).
