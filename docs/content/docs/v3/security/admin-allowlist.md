...
[`/api/whoami`]({{< ref "/docs/v3/operations/api#whoami" >}}) endpoint
...
See the [API reference]({{< ref "/docs/v3/operations/api" >}}) for the full
...
If a proxy is ever exposed via [Tailscale Funnel]({{< ref "/docs/v3/security/funnel" >}}),
